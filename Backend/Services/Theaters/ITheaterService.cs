public interface ITheaterService
{
    ...
    Task<bool> UpdateAvailableSeatsAsync(string theaterId, string timeSlot, int seatsBooked);
    ...
    Task<Theater> AddMovieToTheaterAsync(string theaterId, string movieId);
}
